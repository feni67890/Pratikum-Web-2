  ...
  <div class="form-group row mt-2">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="produk_id" name="produk_id" value="<?= $card['produk_id']?>"
  ...
  <div class="form-group row mt-2">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="jumlah" name="jumlah" value="<?= $card['jumlah']?>"
        type="number" class="form-control">
      </div>
    </div>
  </div>
  ...
  <div class="form-group row mt-2">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="harga" name="harga" value="<?= $card['harga']?>"
        type="number" class="form-control">
      </div>
    </div>
  </div>
  ...
  <div class="form-group row mt-2">
    ...
    <div class="col-8">
      <div class="input-group">
        ...
        <input id="vendor_id" name="vendor_id" value="<?= $card['vendor_id']?>"
        type="number" class="form-control">
      </div>
    </div>
  </div>
